...
class WriteDiaryActivity:AppCompatActivity(), PermissionListener {
    ...
    private fun initView(){
        mIntent = intent
        val date = mIntent.getSerializableExtra("date") as DateTime
         ...
         */
        binding.yearMonthDateTv.text = "${date.year}년 ${date.monthOfYear}월 ${date.dayOfMonth}일"
    ...
    private fun createDiary(){
        ...
        val date = "${year}-${month}-${day} $currentTime"
