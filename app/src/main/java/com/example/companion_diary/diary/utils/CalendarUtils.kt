...
class CalendarUtils {
    ...
    companion object {
        ...
        fun isDiaryExist(date: DateTime, dateList: ArrayList<String>): Boolean {
        ...
        fun checkToday(today: DateTime, date: DateTime): Boolean =
            today.year == date.year && today.monthOfYear == date.monthOfYear && today.dayOfMonth == date.dayOfMonth
    }
}